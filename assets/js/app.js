...
function updateToolTip(chosenXAxis, circlesGroup) {
  ...
  circlesGroup.on("mouseover", function(indata) {
    toolTip.show(indata, this);
  })
    // onmouseout event
    .on("mouseout", function(indata, index) {
      toolTip.hide(indata);
    });
...
d3.csv("assets/data/data.csv").then(function(data, err) {
    ...
    data.forEach(function(indata) {
      indata.age = +indata.age;
      indata.smokes = +indata.smokes;
      indata.smokesLow = +indata.smokesLow;
      indata.smokesHigh = +indata.smokesHigh;
      //indata.abbr = +indata.abbr;
    });
    ...
    labelsGroup.selectAll("text")
      .on("click", function() {
        ...
        if (value !== chosenXAxis) {
          ...
          xLinearScale = xScale(indata, chosenXAxis);
